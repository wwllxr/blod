    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item"><a href="javascript:;">
                <img src="${session_user.userAvatar}" class="layui-nav-img">
                admin
            </a>
                <dl class="layui-nav-child">
                    <dd>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed"><a class=""
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="article/1">全部文章</a>
                        </dd>
                        <dd>
                            <a href="article/toAddArticle">写文章</a>
                        </dd>
                        <dd>
                ...
                <li class="layui-nav-item"><a class="" href="javascript:;">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="user/userList/1">全部用户</a>
                        </dd>
                        <dd>
                            <a href="jsp/user/User_Add.jsp">添加用户</a>
                        </dd>
                    </dl></li>
